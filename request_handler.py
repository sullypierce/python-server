...
from animals import get_all_animals, get_single_animal, create_animal, delete_animal, update_animal, get_animals_by_key
    ...
    def do_GET(self):
        ...
        # `/resource?parameter=value`
            ...
            if key == "email" and resource == "customers":
                ...
                response = get_animals_by_key(key, value)
